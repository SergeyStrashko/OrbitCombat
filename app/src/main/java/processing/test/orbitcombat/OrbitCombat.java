...
public class OrbitCombat extends PApplet {
    ...
    private boolean clickedOnMultiplayer            = false;
    ...
    public void touchStarted() {
        ...
        if (menu.isClickedMultiplayerButton(mouseX, mouseY)) clickedOnMultiplayer = true;
    }
